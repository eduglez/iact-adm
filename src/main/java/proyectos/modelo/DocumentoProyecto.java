...
public class DocumentoProyecto implements Serializable {
   ...
   public String asignarAProyecto(){
            File directorioEmpleado = new File("/home/intranet/proyectos/" + getProyecto().getId());
            ...
            if(getFile()!=null){
                ...
                f.renameTo(fnuevo);
                setFile(fnuevo);
                getProyecto().getDocumentos().add(this);
                f.delete();
            }else{
    ...
    public boolean equals(Object obj) {
        ...
        final DocumentoProyecto other = (DocumentoProyecto) obj;
